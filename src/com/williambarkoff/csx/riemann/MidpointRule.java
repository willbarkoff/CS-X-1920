...
/**
 * RightHandRule approximates the Riemann sum at the midpoint of each subinterval.
 *
...
public class MidpointRule extends AbstractRiemann {
    ...
    public void slicePlot(@NotNull PlotFrame pframe, @NotNull Polynomial poly, double sleft, double sright) {
        DrawableShape rect = ShapeFun.createRectangle(sleft, 0, sright - sleft, poly.evaluateWith((sright + sleft) / 2));
