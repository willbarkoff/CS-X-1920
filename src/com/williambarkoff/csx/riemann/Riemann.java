...
public abstract class Riemann {
    /**
     * Calculates Δx based on the endpoints of the Riemann sum and the number of subintervals; in other words, this method finds the width of each rectangle.
     *
    ...
    /**
     * Calculates a Riemann sum, using the particular implementation of {@link Riemann#slice​(org.dalton.polyfun.Polynomial, double, double)} defined in the subclass.
     *
    ...
    public double rs(Polynomial poly, double left, double right, int subintervals) {
        ...
        for (double i = left; i <= right; i += deltaX) {
            area += slice​(poly, left, right);
        }
        return area;
    }

    /**
     * Graphs the accumulation function corresponding to the input polynomial and the input left hand endpoint. This method uses the specific implementation of {@link Riemann#slicePlot​(org.opensourcephysics.frames.PlotFrame, org.dalton.polyfun.Polynomial, double, double)} defined in the subclass.
     *
    ...
    /**
     * Approximates a slice of the (signed) area between the graph of a polynomial and the x-axis, over a given interval on the x-axis. The specific Riemann sum rule used in the calculation is defined by the subclass. This method should be used in {@link Riemann#rs(Polynomial, double, double, int)} to find the total area.
     *
    ...
    /**
     * Plots a slice of the (signed) area between the graph of a polynomial and the x-axis, over a given interval on the x-axis. The specific Riemann sum rule used is defined by the subclass. This method should be used in {@link Riemann#rsPlot​(org.opensourcephysics.frames.PlotFrame, org.dalton.polyfun.Polynomial, int, double, double, double, int)} to find the total area.
     *
